...
namespace Library
{
	...
	void AnimationPlayer::GetBindPoseBottomUp(SceneNode& sceneNode)
	{
		...
		SceneNode* parentNode = sceneNode.ParentNode();
	...
	void AnimationPlayer::GetBindPose(SceneNode& sceneNode)
	{
		...
		XMMATRIX toRootTransform = (sceneNode.ParentNode() != nullptr ? toParentTransform * XMLoadFloat4x4(&(mToRootTransforms.at(sceneNode.ParentNode()))) : toParentTransform);
	...
	void AnimationPlayer::GetPose(float time, SceneNode& sceneNode)
	{
		...
		XMMATRIX toRootTransform = (sceneNode.ParentNode() != nullptr ? XMLoadFloat4x4(&toParentTransform) * XMLoadFloat4x4(&(mToRootTransforms.at(sceneNode.ParentNode()))) : XMLoadFloat4x4(&toParentTransform));
		XMStoreFloat4x4(&(mToRootTransforms[&sceneNode]), toRootTransform);
