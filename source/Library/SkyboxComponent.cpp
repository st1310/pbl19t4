...
namespace Library
{
	...
	SkyboxComponent::SkyboxComponent(Game& game, Camera& camera, const std::wstring& cubeMapFileName, float scale) :
	...
	void SkyboxComponent::Update(const GameTime& gameTime)
	{
	...
	void SkyboxComponent::Draw(const GameTime& gameTime)
	{
