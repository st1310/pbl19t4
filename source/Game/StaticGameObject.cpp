...
namespace Rendering
{
	...
	// Transformation
	void StaticGameObject::Scale(float x, float y, float z)
	{
	...
	void StaticGameObject::Scale(XMFLOAT3 scale)
	{
		XMFLOAT3 newScale = XMFLOAT3(
			mScale.x + scale.x,
			mScale.y + scale.y,
	...
	void StaticGameObject::Rotate(float x, float y, float z)
	{
		mRotation.x += x;
		mRotation.y += y;
		mRotation.z += z;
	...
	void StaticGameObject::Rotate(XMFLOAT3 rotation)
	{
	...
	void StaticGameObject::FirstRotation()
	{
	...
	void StaticGameObject::Translate(float x, float y, float z)
	{
		mPosition.x += x;
		mPosition.y += y;
		mPosition.z += z;
	...
	void StaticGameObject::Translate(XMFLOAT3 translation)
	{
	...
	// Creation Kit
	std::vector<std::string> StaticGameObject::Serialize()
	{
	...
	void StaticGameObject::EditModel()
	{
		ChangeEditFactor();
		ChangeEditMode();
		ChangeEditAxis();
	...
	void StaticGameObject::ChangeEditFactor()
	{
	...
	void StaticGameObject::SetPosition()
	{
		if (mPrecisionMode)
		{
			if (mEditAxis == X_AXIS)
	...
	void StaticGameObject::SetRotation()
	{
		if (mPrecisionMode)
		{
			if (mEditAxis == X_AXIS)
	...
	void StaticGameObject::SetScale()
	{
		if (mPrecisionMode)
		{
			if (mEditAxis == X_AXIS)
	...
	void StaticGameObject::ChangeEditAxis()
	{
	...
	void StaticGameObject::ChangeEditMode()
	{
